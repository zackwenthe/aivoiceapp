...
/// 
/// MLX models should be available on Hugging Face with the following files:
/// - `config.json`: Model configuration
/// - `tokenizer.json`: Tokenizer vocabulary and merges
/// - `tokenizer_config.json`: Tokenizer configuration
/// - `model.safetensors` or `weights.safetensors`: Model weights
/// 
/// Optional files (downloaded if available):
